...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    clean: ['src/angular-confirmable.js'],
    ...
    concat: {
      dist: {
        ...
        options: {
          ...
          banner: "'use strict';\nangular.module('angular-confirmable', []);",
        ...
        src: ['src/*.js'],
        dest: 'src/angular-confirmable.js'
      },
    },
    ...
    sass: {
      dist: {
        files: {
          'src/angular-confirmable.css':'src/angular-confirmable.scss',
        }
      }
    },
